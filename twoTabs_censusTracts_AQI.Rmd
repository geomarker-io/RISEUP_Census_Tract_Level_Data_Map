...
Using the menu on the left-hand side of the map, you can toggle variables on/off. Clicking on a census tract displays all variables for that census tract.
...
Current air quality in Cincinnati area can be found on [AirNow](https://www.airnow.gov/?city=Cincinnati&state=OH&country=USA)
